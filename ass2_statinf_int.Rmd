...
```{r conditional boxplots, fig.height=5, fig.width=7.5}
...
```{r miltiplot, fig.height=15, fig.width=12}
...
For every single difference vector I wnat to test, i will provide a plot and a comment. Looking at the plot remember that the red line represents the rejection region, while the blue one is the t statistics result of the test.
